...
import ConfigPublicCondition from "../types/conditions/ConfigPublicCondition";
...
export default abstract class ConfigConditionLoader {
  ...
  public static getConditionFromInput(
    ...
    switch (type) {
      case ConfigConditionType.PUBLIC:
        return new ConfigPublicCondition();
      case ConfigConditionType.CUSTOM_FIELD:
        return new ConfigCustomFieldCondition(args.input);
      case ConfigConditionType.EMAIL:
        return new ConfigEmailCondition(args.input);
      case ConfigConditionType.LOCALE:
        return new ConfigLocaleCondition(args.input);
      case ConfigConditionType.UNIT_ID:
        return new ConfigUnitIDCondition(args.input);
      case ConfigConditionType.USER_ID:
        return new ConfigUserIDCondition(args.input);
      default:
